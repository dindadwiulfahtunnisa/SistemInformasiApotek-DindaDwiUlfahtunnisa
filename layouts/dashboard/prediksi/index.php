...
$prediksis = query("SELECT * FROM tbl_prediksi");


if (isset($_POST['submit'])) {
    $kode_ramalan   = htmlspecialchars($_POST['kode_ramalan']);
    ...
    $query_create = "INSERT INTO tbl_prediksi (
                        kode_ramalan, obat_id,
                        kode_obat, bulan,
                        tahun, hasil
                        ) VALUES ( 
                            '$kode_ramalan', '$obat_id',
    ...
    $nama_obat_checker = "SELECT * FROM tbl_prediksi WHERE nama_prediksi='$nama_obat'";
